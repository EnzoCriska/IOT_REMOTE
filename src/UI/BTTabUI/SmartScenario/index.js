...
export default class SmartScenario extends Component{
...
const client = new Client({ uri:'wss://m10.cloudmqtt.com:32554/mqtt', clientId: 'web_83434287hshd6e2', storage: myStorage }); // chỗ này liên kết nè, sau đó nó phát ra một sự kiện nào đó ở bên dưới
